export const catBreeds = ['Mixed','Unknown','Other','American Shorthair', 'Abyssinian', 'American Curl','British Shorthair','Bengal','Burmese','Birman',
  ...
  'Turkish Van'];
export const dogBreeds = ['Mixed','Unknown','Other','Australian Shepherd','American Cocker Spaniel', 'Akita', 'Airedale Terrier',
...
export const reptileBreeds = ['Frog', 'Turtle', 'Snake','Iguana','Gecko','Chameleon','Lizard','Other'];
