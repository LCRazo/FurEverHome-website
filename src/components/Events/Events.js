...
function Events() {
    return(
        ...
        <section id="events" className= "bg-deaf51 py-12 px-4 text-center ">
              {/*Title */}
               {/*mb = margin botton ml= margin left */}
              <div className="flex justify-center mb-10">
              <img src={event} alt="event-img"lassName="h-20 md:h-auto"></img>
              </div>
            ...
            <div className="flex flex-col items-center">
                        <div className="mb-3 overflow-hidden flex items-center justify-center">
                            <img src={eventLogo} alt="logoFooter" className="" ></img>
                        </div>
            </div>
            ...
            <div className="flex flex-col items-center">
                        ...
                        <Link to='/api/pets/adopt/login?choice=event' className='mt-4 bg-a87834 text-white font-saira text-2xl px-5 py-2 rounded-md hover:bg-a06EB1 transition-colors no-underline hover:no-underline'>Create Event</Link>
            </div>
